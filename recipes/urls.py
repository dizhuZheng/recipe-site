...
from .views import PostDetailView, PostListView, CommentCreateView, CommentDeleteView, CreateRecipeView, PostDeleteView, favorite, like_up, test_page, test_ajax
...
urlpatterns = [
    ...
    path('a/', test_page, name='test'),
    path('a/ajax/', test_ajax, name='ajax'),
